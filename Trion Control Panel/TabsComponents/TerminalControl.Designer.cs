...
namespace TrionControlPanel.TabsComponents
{
    partial class TerminalControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnLoadRealm = new TrionControlPanelUI.CustomButton();
            this.btnSetRealm = new TrionControlPanelUI.CustomButton();
            this.txtRealmRegion = new TrionControlPanelUI.CustomTextBox();
            this.txtRealmGameBuild = new TrionControlPanelUI.CustomTextBox();
            this.txtRealmTimeZone = new TrionControlPanelUI.CustomTextBox();
            this.txtRealmPort = new TrionControlPanelUI.CustomTextBox();
            this.txtRealmSubMask = new TrionControlPanelUI.CustomTextBox();
            this.txtRealmLocalAddress = new TrionControlPanelUI.CustomTextBox();
            this.txtRealmAddress = new TrionControlPanelUI.CustomTextBox();
            this.txtRealmName = new TrionControlPanelUI.CustomTextBox();
            this.lblServerStatus = new System.Windows.Forms.Label();
            this.label12 = new System.Windows.Forms.Label();
            this.customPanelPanel2 = new TrionControlPanelUI.CustomPanel();
            this.btnCreateAccount = new TrionControlPanelUI.CustomButton();
            this.txtEmail = new TrionControlPanelUI.CustomTextBox();
            this.tglShowPassword = new TrionControlPanelUI.CustomToggleButton();
            this.txtRePassword = new TrionControlPanelUI.CustomTextBox();
            this.txtUsername = new TrionControlPanelUI.CustomTextBox();
            this.txtPassword = new TrionControlPanelUI.CustomTextBox();
            this.customPanelPanel3 = new TrionControlPanelUI.CustomPanel();
            this.btnSetGMLvl = new TrionControlPanelUI.CustomButton();
            this.customTextBox18 = new TrionControlPanelUI.CustomTextBox();
            this.txtUserGM = new TrionControlPanelUI.CustomTextBox();
            this.lblSetGMLevel = new System.Windows.Forms.Label();
            this.timerCheck = new System.Windows.Forms.Timer(this.components);
            this.customPanelPanel4 = new TrionControlPanelUI.CustomPanel();
            this.txtChangePasswordCurrentPassword = new TrionControlPanelUI.CustomTextBox();
            this.btnChangePassword = new TrionControlPanelUI.CustomButton();
            this.txtChangePasswordEmail = new TrionControlPanelUI.CustomTextBox();
            this.tglChengePasswordShowPassword = new TrionControlPanelUI.CustomToggleButton();
            this.txtChangePasswordReNewPassword = new TrionControlPanelUI.CustomTextBox();
            this.txtChangePasswordNewPassword = new TrionControlPanelUI.CustomTextBox();
        ...
        private TrionControlPanelUI.CustomButton btnSetRealm;
        private TrionControlPanelUI.CustomPanel customPanelPanel4;
        private TrionControlPanelUI.CustomTextBox txtChangePasswordCurrentPassword;
        private TrionControlPanelUI.CustomButton btnChangePassword;
        private TrionControlPanelUI.CustomTextBox txtChangePasswordEmail;
        private TrionControlPanelUI.CustomToggleButton tglChengePasswordShowPassword;
        private CustomTextBox txtChangePasswordReNewPassword;
        private TrionControlPanelUI.CustomTextBox txtChangePasswordNewPassword;
        private Label label15;
        internal TrionControlPanelUI.CustomTextBox txtRealmLocalAddress;
        internal TrionControlPanelUI.CustomTextBox txtRealmAddress;
        internal TrionControlPanelUI.CustomTextBox txtRealmName;
        internal TrionControlPanelUI.CustomTextBox txtRealmPort;
        internal TrionControlPanelUI.CustomTextBox txtRealmSubMask;
        internal TrionControlPanelUI.CustomTextBox txtRealmRegion;
        internal TrionControlPanelUI.CustomTextBox txtRealmGameBuild;
        internal TrionControlPanelUI.CustomTextBox txtRealmTimeZone;
        private System.Windows.Forms.Timer timerRefresh;
        private TrionControlPanelUI.CustomButton btnLoadRealm;
