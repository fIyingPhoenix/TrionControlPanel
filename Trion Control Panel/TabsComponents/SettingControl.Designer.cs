...
namespace TrionControlPanel.TabsComponents
{
    partial class SettingControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtAuthDatabase = new TrionControlPanelUI.CustomTextBox();
            this.txtMySqlPort = new TrionControlPanelUI.CustomTextBox();
            this.txtMySqlPassowrd = new TrionControlPanelUI.CustomTextBox();
            this.txtMySqlUser = new TrionControlPanelUI.CustomTextBox();
            this.txtMySqlServer = new TrionControlPanelUI.CustomTextBox();
            this.lblMySqlServerSettings = new System.Windows.Forms.Label();
            this.tglStayInTray = new TrionControlPanelUI.CustomToggleButton();
            this.lblRestartServerOnCrash = new System.Windows.Forms.Label();
            this.tglRestartOnCrash = new TrionControlPanelUI.CustomToggleButton();
            this.lblStartServerOnLaunch = new System.Windows.Forms.Label();
            this.tglStartServer = new TrionControlPanelUI.CustomToggleButton();
            this.lblStartWithWindows = new System.Windows.Forms.Label();
            this.tglStartOnStartup = new TrionControlPanelUI.CustomToggleButton();
            this.lblCores = new System.Windows.Forms.Label();
            this.lblHideControls = new System.Windows.Forms.Label();
            this.tglHideConsole = new TrionControlPanelUI.CustomToggleButton();
            this.lblNotySound = new System.Windows.Forms.Label();
            this.tglNotySound = new TrionControlPanelUI.CustomToggleButton();
            this.lblStayTray = new System.Windows.Forms.Label();
            this.lblControlPanelSettings = new System.Windows.Forms.Label();
            this.btnSave = new TrionControlPanelUI.CustomButton();
            this.lblCustomNames = new System.Windows.Forms.Label();
            this.tglCustomNames = new TrionControlPanelUI.CustomToggleButton();
            this.txtMysqlName = new TrionControlPanelUI.CustomTextBox();
            this.lblNames = new System.Windows.Forms.Label();
            this.txtWorldName = new TrionControlPanelUI.CustomTextBox();
            this.txtBnetName = new TrionControlPanelUI.CustomTextBox();
            this.timerCheck = new System.Windows.Forms.Timer(this.components);
            this.btnTestMySQL = new TrionControlPanelUI.CustomButton();
            this.panelNames = new TrionControlPanelUI.CustomPanel();
            this.panelControSettins = new TrionControlPanelUI.CustomPanel();
            this.btnFixMysql = new TrionControlPanelUI.CustomButton();
            this.PanelMySelSettings = new TrionControlPanelUI.CustomPanel();
            this.btCoreLocationSearch = new TrionControlPanelUI.CustomButton();
            this.lblPCresource = new System.Windows.Forms.Label();
            this.txtWorldLocation = new TrionControlPanelUI.CustomTextBox();
            this.bntOpenLocation = new TrionControlPanelUI.CustomButton();
            this.bntOpenMySqlLocation = new TrionControlPanelUI.CustomButton();
            this.comboBoxCore = new MetroFramework.Controls.MetroComboBox();
            this.PanelServerLocation = new TrionControlPanelUI.CustomPanel();
            this.txtCoreLocation = new TrionControlPanelUI.CustomTextBox();
            this.txtMysqlLocation = new TrionControlPanelUI.CustomTextBox();
            this.btnMySQLLocationSearch = new TrionControlPanelUI.CustomButton();
            this.lblServerLocation = new System.Windows.Forms.Label();
            this.btnCoreLocation = new TrionControlPanelUI.CustomButton();
            this.btnMysqlLocation = new TrionControlPanelUI.CustomButton();
