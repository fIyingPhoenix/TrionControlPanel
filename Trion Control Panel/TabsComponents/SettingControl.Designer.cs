...
namespace TrionControlPanel.TabsComponents
{
    partial class SettingControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtAuthDatabase = new CustomTextBox();
            this.txtMySqlPort = new CustomTextBox();
            this.txtMySqlPassowrd = new CustomTextBox();
            this.txtMySqlUser = new CustomTextBox();
            this.txtMySqlServer = new CustomTextBox();
            this.lblMySqlServerSettings = new System.Windows.Forms.Label();
            this.tglStayInTray = new CustomToggleButton();
            this.lblRestartServerOnCrash = new System.Windows.Forms.Label();
            this.tglRestartOnCrash = new CustomToggleButton();
            this.lblStartServerOnLaunch = new System.Windows.Forms.Label();
            this.tglStartServer = new CustomToggleButton();
            this.lblStartWithWindows = new System.Windows.Forms.Label();
            this.tglStartOnStartup = new CustomToggleButton();
            this.lblCores = new System.Windows.Forms.Label();
            this.lblHideControls = new System.Windows.Forms.Label();
            this.tglHideConsole = new CustomToggleButton();
            this.lblNotySound = new System.Windows.Forms.Label();
            this.tglNotySound = new CustomToggleButton();
            ...
            this.tglCustomNames = new CustomToggleButton();
            this.txtMysqlName = new CustomTextBox();
            this.lblNames = new System.Windows.Forms.Label();
            this.txtWorldName = new CustomTextBox();
            this.txtBnetName = new CustomTextBox();
            this.timerCheck = new System.Windows.Forms.Timer(this.components);
            this.btnTestMySQL = new CustomButton();
            this.panelNames = new CustomPanel();
            this.panelControSettins = new CustomPanel();
            this.btnFixMysql = new CustomButton();
            this.PanelMySelSettings = new CustomPanel();
            this.btCoreLocationSearch = new CustomButton();
            this.lblPCresource = new System.Windows.Forms.Label();
            this.txtWorldLocation = new CustomTextBox();
            this.bntOpenLocation = new CustomButton();
            this.bntOpenMySqlLocation = new CustomButton();
            this.comboBoxCore = new MetroFramework.Controls.MetroComboBox();
            this.PanelServerLocation = new CustomPanel();
            this.txtCoreLocation = new CustomTextBox();
            this.txtMysqlLocation = new CustomTextBox();
            this.btnMySQLLocationSearch = new CustomButton();
            this.lblServerLocation = new System.Windows.Forms.Label();
            this.btnCoreLocation = new CustomButton();
            this.btnMysqlLocation = new CustomButton();
