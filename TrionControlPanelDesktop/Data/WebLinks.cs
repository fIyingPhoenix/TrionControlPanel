...
namespace TrionControlPanelDesktop.FormData
{
    public class WebLinks
    {
        ...
        public static string TrionUpdate { get => "http://web.aclab.local/data/update/trion.txt"; }
        public static string MySQLUpdate { get => "http://web.aclab.local/data/update/mysql.txt"; }
        public static string SPPCoreUpdate { get => "http://web.aclab.local/data/update/spp.txt"; }
        public static string Discord { get => "https://discord.gg/G88v939z"; }
    }
}
